"""
RD++ Noising configuration for ViSA dataset - 256x256, 100 epochs.

Two-phase training:
Phase 1: Build memory bank from teacher features
Phase 2: Train decoder with adaptive noise + RD++ projection losses

Data and training hyperparameters aligned with configs/invad/invad_visa.py for ViSA.
"""
...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rdpp_noising):
    ...
    def __init__(self):
        ...
        # ==> data (ViSA dataset, aligned with invad_visa.py)
        ...
        self.wandb.tags = ['rdpp', 'noising', '100epochs', 'visa']
        self.wandb.notes = 'RDPP Noising on ViSA dataset with adaptive noise injection'
